          ...
          <div className="steps-container2 thq-grid-2">
            ...
            <div className="steps-container3">
              ...
              <div className="steps-containerD thq-card">
                <label className="steps-text14 thq-heading-2">04</label>
                <h2 className="thq-heading-3">{props.step4Title}</h2>
                <img
                  alt={props.imageAlt7}
                  src={props.imageSrc7}
                  className="steps-image1"
                ...
                <span className="steps-text5 thq-body-xs">{props.step4AditionalDescription}</span>

              </div>

              {/* Añadiendo el paso 5 */}
              <div className="steps-containerA thq-card">
                <label className="steps-text14 thq-heading-2">05</label>
                <h2 className="thq-heading-3">{props.step5Title}</h2>
                <img
                  alt={props.imageAlt9}
                  src={props.imageSrc9}
                  className="steps-image1"
                ...
                <span className="steps-text5 thq-body-xs">{props.step5AditionalDescription}</span>

              </div>

              {/* Añadiendo el paso 6 */}
              <div className="steps-containerB thq-card">
                <label className="steps-text14 thq-heading-2">06</label>
                <h2 className="thq-heading-3">{props.step6Title}</h2>
                <img
              ...
              {/* Añadiendo el paso 7 */}
              <div className="steps-containerC thq-card">
                <label className="steps-text14 thq-heading-2">07</label>
                <h2 className="thq-heading-3">{props.step7Title}</h2>
                <img
                  alt={props.imageAlt12}
                  src={props.imageSrc12}
                  className="steps-image1"
                />
                <span className="steps-text13 thq-body-small">{props.step7Description}</span>
                <span className="steps-text5 thq-body-xs">{props.step7AditionalDescription}</span>
              </div>

              {/* Añadiendo el paso 8 */}
              <div className="steps-containerD thq-card">
                <label className="steps-text14 thq-heading-2">08</label>
                <h2 className="thq-heading-3">{props.step8Title}</h2>
                <img
                ...
                <span className="steps-text5 thq-body-xs">{props.step8AditionalDescription}</span>
              </div>

              {/* Añadiendo el paso 9 */}
              <div className="steps-containerA thq-card">
                <label className="steps-text14 thq-heading-2">09</label>
                <h2 className="thq-heading-3">{props.step9Title}</h2>
                <img
